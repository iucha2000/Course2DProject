...
public class Test : MonoBehaviour
{
    ...
    //    print("Coroutine continued after 2 seconds");

    //    yield return new WaitUntil(() => Input.GetKeyDown(KeyCode.Space));
    //    print("Coroutine continued after space key pressed");

    //    yield return new WaitWhile(() => Input.GetKey(KeyCode.Space));
    //    print("Coroutine ended after space key released");

    //    yield return new WaitForSecondsRealtime(1f);
    //    print("Coroutine continued after 1 second in real time");
    //}
